...
CREATE TABLE "conversation" (
	...
	"modelId" text DEFAULT 'ollama:qwen2.5' NOT NULL,
	"personaId" text DEFAULT 'haji' NOT NULL,
...
CREATE INDEX "conversation_user_idx" ON "conversation" USING btree ("userId");--> statement-breakpoint
